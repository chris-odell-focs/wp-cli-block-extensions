                ...
                if( $block->namespace == $namespace ) { 
                    ...
                    switch( $args[1] ) {
                        ...
                        case 'pf':
                            ...
                            $update_value = $blex_info->source_folder.DIRECTORY_SEPARATOR.$directory_arg.DIRECTORY_SEPARATOR.$basename;
                    ...
                    if( file_exists( $destination_directory ) ){
                        ...
                        if( '' !== $source ) {
                            ...
                            $plugin_php_content = str_replace( $block->plugin_data->location, $update_value, $plugin_php_content );
                            ...
                            if( is_dir( $destination ) ) {
                                ...
                                $block->plugin_data->location = $update_value;
                            }
